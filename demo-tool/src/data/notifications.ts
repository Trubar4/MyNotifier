...
export const DEFAULT_NOTIFICATIONS: Notification[] = [
  {
    ...
    body: 'Windvorhersage bis zu 8.0 m/s am Standort 88400 Biberach. Aktuelle Position: Parkposition. Max. sicherer Wind: 75 m/s. Bitte Auslegerposition prüfen und ggf. Maßnahmen einleiten.',
  ...
  },
  {
    ...
    body: 'Windvorhersage bis zu 8.0 m/s. Letzte bekannte Position: Parkposition (aktuell). Bitte bestätigen Sie, dass sich der Kran in einer sicheren Position befindet.',
  ...
  },
  {
    ...
    body: 'Windvorhersage bis zu 15.2 m/s am Standort 80335 München. Letzte bekannte Position: Parkposition (vor 48 Stunden). SOFORTIGE MASSNAHME ERFORDERLICH: Bitte prüfen und aktualisieren Sie die Kranposition dringend.',
